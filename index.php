        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-body p-1">
              ...
              <h6> <small><s class="text-secondary"><i class="fa-solid fa-naira-sign"></i>519</s></small></h6>
              <h5 class="card-text text-center text-success"><i class="fa-solid fa-naira-sign"></i>&nbsp;&nbsp;<?= number_format($row['product_price'],2) ?></h5>
